...
public class UserController extends BaseController {
  ...
  public Object addUser(@RequestParam Map<String, String> params) {
    ...
    try {
      ...
      if(branch != null && branch.contains("~")) {
        ...
        user.branchId = Long.valueOf(tmp[0]);
        user.branchName = tmp[1];
      }
  ...
  public String indexGroupEdit(Model model, @PathVariable("id") String id) {
    ...
    model.addAttribute("branchId", users[0].branchId);
    model.addAttribute("branchName", users[0].branchName);
  ...
  public String userInformation(Model model, @PathVariable String userName) {
    ...
    model.addAttribute("branchId", byUsername.branchId);
    model.addAttribute("branchName", byUsername.branchName);
