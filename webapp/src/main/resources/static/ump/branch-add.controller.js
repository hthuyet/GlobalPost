UserWebApp.controller('BranchAddController', function ($http, $scope, HttpService, CommonService, $translate) {
  $scope.item = {};
  ...
  $scope.onSubmitFrm = function () {
    ...
    if ($scope.id != null && $scope.id != '') {
      HttpService.postData('/branch/save', params, btnSubmitElement).then(function (response) {
