UserWebApp.controller('PartnerAddController', function ($http, $scope, HttpService, CommonService, $translate) {
  $scope.item = {};
  ...
  $scope.onSubmitFrm = function () {
    ...
    if ($scope.id != null && $scope.id != '') {
      HttpService.postData('/partner/save', params, btnSubmitElement).then(function (response) {
