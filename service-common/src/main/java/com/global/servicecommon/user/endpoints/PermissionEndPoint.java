...
import com.global.servicecommon.user.model.PermissionSearchForm;
import com.global.servicecommon.user.model.Permission;
import com.global.servicecommon.user.services.PermissionsService;
...
public class PermissionEndPoint extends SsdcCrudEndpoint<Long, Permission> {
    ...
    public List<Permission> checkExistName(@RequestBody PermissionSearchForm searchParameter) throws Exception {
        logger.info("#USER_LOG {},{},{},{},{}", session.getId(), session.getAttribute("username"), "go to list groups page", "", "");
